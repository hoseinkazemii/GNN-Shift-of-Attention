...
params = {"num_samples":29,  # Number of participants to use for training/testing
          "test_fraction":0.2, # Fraction of participants to use for testing
          "val_fraction":0.1, # Fraction of participants to use for validation
          ...
          "dist_threshold":8.0, # Distance threshold to consider a fixation as critical
          "LOOKAHEAD_SECONDS" : 15.0,  # How many seconds into the future to look for the label
          "MIN_FIXATION_DURATION" : 0.3,  # Minimum fixation duration in seconds to consider a valid fixation
          "window_size":50, # Size of the sliding window for RNN
          "num_epochs":10,
          "batch_size":32,
          "learning_rate":0.001,
...
def main():
    ...
    # split_loader = STGCNDatasetSplitByParticipant("processed_data/stgcn_dataset_{}_{}_{}_{}_participants.pt".format(params["dist_threshold"], params["LOOKAHEAD_SECONDS"], params["MIN_FIXATION_DURATION"], int(params["num_samples"])), **params)
    ...
    history = train_rnn(model, train_dataset, val_dataset, test_dataset, pos_weight, **params)
